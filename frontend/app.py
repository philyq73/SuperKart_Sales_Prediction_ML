...
Product_Id_First2 = st.selectbox(
    "Product ID First 2 Characters",
    ["FD", "DR", "NC"]
)

Store_Establishment_Age = st.number_input(
    "Store Establishment Age",
    min_value=0,
    value=16
)
...
product_data = {
    ...
    "Product_Id_First2": Product_Id_First2,
    "Store_Establishment_Age": Store_Establishment_Age,
